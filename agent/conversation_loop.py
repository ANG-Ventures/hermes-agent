...
from agent.confab_notice import TOOL_CALL_NOTICE_TEXT, confab_notice_status
...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        for idx, msg in enumerate(messages):
            ...
            # Metadata-only provider events are durable UI records, not system
            # instructions. Scaffold notices on real assistant prose still replay.
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                # A validated tool notice is a dropped-call outcome, even when
                # finish_reason is stop. Recover before empty-content handling.
                ...
                if _tool_notice_nudge:
                    # Same validated display fields and transcript persistence;
                    # a metadata-only event, never an empty assistant turn.
                ...
                if finish_reason == "tool_calls" or _tool_notice_nudge:
                    if getattr(agent, "_dropped_toolcall_retries", 0) < 3:
                        ...
                        continue
                    if _tool_notice_nudge:
                        # Explicit failed outcome, not another empty retry or
                ...
                # Workers must close their run (complete, block, or review handoff).
                ...
                if _kanban_nudge:
                    ...
                    agent._emit_status(
                        ...
                        "a terminal run handoff — nudging to finish"
                    )
