...
def _mask_read_only_python_paths(body: str) -> str:
    ...
    try:
        ...
        return body
    # A trusted spelling can be rebound to a side-effecting callable. If any
    # diagnostic-loop dependency is mutable here, keep the path visible.
    ...
    if any(
        ...
        or (isinstance(n, (ast.Attribute, ast.Subscript)) and not isinstance(n.ctx, ast.Load))
