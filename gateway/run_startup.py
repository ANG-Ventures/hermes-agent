            ...
            try:
                ...
                self._loop_liveness_watchdog = start_loop_liveness_watchdog(
                    ...
                    starvation_load_factor=float(getattr(
                        config, "liveness_starvation_load_factor", DEFAULT_LIVENESS_STARVATION_LOAD_FACTOR
                    )),
                    starvation_max_hold_s=float(getattr(
                        config, "liveness_starvation_max_hold_s", DEFAULT_LIVENESS_STARVATION_MAX_HOLD_S
                    )),
                )
            except Exception:
