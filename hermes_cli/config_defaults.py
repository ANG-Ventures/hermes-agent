...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        "restart_drain_timeout": 180,  # fork parity 2026-08-07: fork value (upstream 0)
    ...
    "compression": {
        ...
        "hygiene_hard_message_limit": 400,  # gateway session-hygiene force-compress threshold by message count  # fork parity 2026-08-07: fork value (upstream 5000)
        "hygiene_timeout_seconds": None,  # max seconds gateway waits for pre-agent hygiene compression  # fork parity 2026-08-07: fork value (upstream 30)
    ...
    # DEFAULT_CONFIG into this module. Fork-owned; keep on future syncs.
                           # "codex_responses", or "anthropic_messages". Empty = auto-detect
                           # from URL (e.g. /anthropic suffix → anthropic_messages). Set this
                           # explicitly for non-standard endpoints the URL heuristic can't identify.
        "resume_on_restart": True,  # recover gateway background delegations after restart
    ...
    "kanban": {
        ...
        # --force bypasses it.
        # "none": no card gets a reviewer session at all — every review
        # request completes in place (review_skipped), milestones included;
        # same human/--force bypass. The reviewer-profile off switch.
        "review_policy": "all",
