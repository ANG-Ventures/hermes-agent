...
NOTE (t_55547259): this file is OWNED by card t_343f0279 and vendored here
byte-identical (blob 1d8e65fa) from ``work/t_343f0279-flagship-guard`` so the
per-call override surface can import one predicate instead of forking it.
When t_343f0279 lands, DROP this copy in the rebase and keep theirs.
