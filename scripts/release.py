...
LEGACY_AUTHOR_MAP = {
    # ── Fork-owner / orchestrator identities (Kyzcreig fork) — preserved across
    # the 2026-07-23 upstream parity merge when upstream moved to the
    # contributors/emails/ directory. These are fork-only and must stay mapped
    # so the contributor-check gate resolves fork-authored commits.
    "apollo@kyzcreig.local": "Kyzcreig",  # Apollo (fleet orchestrator agent) — fork-authored fixes under the Kyzcreig fork owner
    ...
    "Kyzcreig@users.noreply.github.com": "Kyzcreig",  # fork owner bare-noreply identity
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # bare-noreply salvage — mapped 2026-06-29 parity sync
