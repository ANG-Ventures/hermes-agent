...
TEST_ENV=()
for _test_var in HERMES_TEST_IMAGE HERMES_TEST_WORKERS HERMES_TEST_WORKERS_FORCE \
  HERMES_TEST_PATHS \
...
exec env -i \
  ...
  ${SESSION_LIST_REAL_COPY_DB:+SESSION_LIST_REAL_COPY_DB="$SESSION_LIST_REAL_COPY_DB"} \
