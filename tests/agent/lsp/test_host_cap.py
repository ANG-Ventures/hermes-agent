...
from agent.lsp.manager import DEFAULT_MAX_SERVERS_PER_HOST, LSPService
...
def test_config_default_cap_reaches_the_service(repo):
    ...
    try:
        ...
        default = DEFAULT_CONFIG["lsp"]["max_servers_per_host"]
        assert default == DEFAULT_MAX_SERVERS_PER_HOST
