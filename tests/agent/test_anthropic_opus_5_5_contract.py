...
Mythos 5.1 shipped the identical restrictions a month earlier.  So the fleet
...
class TestForcedToolChoiceIsDowngraded:
    ...
    def test_downgrade_leaves_the_tool_schemas_untouched(self, model: str) -> None:
        ...
        Measured against this tree's own registry (2026-09-23): 39 of 39 live
        tool schemas violate it — all 39 omit the mandatory
        ...
        test deliberately rather than regress the fleet by accident.
        """
        kwargs = _kwargs(model, tools=TOOLS, tool_choice="get_weather")
