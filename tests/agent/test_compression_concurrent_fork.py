...
# These tests exist on fork/main but not at the frozen upstream
# target 1e5b5074 -- upstream's suite-wide test-prune removed them.
# They guard fork-owned behavior, so the merge keeps them verbatim
# from the fork blob. Everything above is upstream's file as-is.
# --------------------------------------------------------------------------
