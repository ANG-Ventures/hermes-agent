...
class TestFailureAttribution:
    ...
    def test_unmatched_key_does_not_retry_only_pool_entry(
        ...
        ONE adoption of the lone entry's (different) token, since the pool may
        ...
        # using, so adopting it is a real credential change: retry once.
        assert recovered is True
        ...
        # Second pass with the agent STILL on the wrapper key (the swap did not
