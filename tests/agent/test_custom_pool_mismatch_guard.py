...
class TestCustomPoolMismatchGuard:
    ...
    def test_named_custom_provider_rotates_its_matching_pool(self):
        ...
        agent._swap_credential = MagicMock(
            # parity 2026-08-30: _recovered_after_swap now checks the
            # tri-state SwapOutcome; a bare MagicMock reads as not-swapped.
            return_value=__import__("run_agent").SwapOutcome.SWAPPED
        )
