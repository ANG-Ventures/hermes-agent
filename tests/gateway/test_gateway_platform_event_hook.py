...
class TestRegisterHandlers:
    ...
    def test_registers_core_handlers_plus_observer(self):
        ...
        # alone in group 99 (observes alongside rather than displacing the
        # core handlers) plus the fork's intake sentinel alone in group -1
        # (#639 — observes every update strictly before the functional
        # handlers).
