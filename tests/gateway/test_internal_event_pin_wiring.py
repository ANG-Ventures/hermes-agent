"""Call-site wiring guard for the internal-event session-context pin (t_4bcd60ba).
...
``_handle_message_with_agent`` stops forwarding ``event.internal`` (mutant M1
from the t_064c65a9 review).  This test drives the REAL handler through
