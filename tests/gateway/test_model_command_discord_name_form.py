...
Repro (2026-09-24, Ace): on Telegram, current provider claude-apr,
``/model name:claude-bpx-5/claude-fable-5-1`` left the session on
``claude-apr/name:claude-bpx-5/claude-fable-5-1``.
