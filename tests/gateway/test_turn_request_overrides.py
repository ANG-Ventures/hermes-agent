...
def test_provider_request_overrides_merged_under_fast_mode(monkeypatch):
    ...
    # 2026-08 parity merge: the turn path resolves fast-mode through the
    # fork's capability gate (resolve_fast_mode_capability), not the legacy
    # resolve_fast_mode_overrides helper.
