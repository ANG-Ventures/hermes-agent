...
class TestRestartLoopGuard:
    ...
    def test_is_tripped_reads_without_recording(self):
        import gateway.restart_loop_guard as rlg
        rlg.record_restart_interrupted_boot(60, now=1000.0, boot_id="boot-1")
        rlg.record_restart_interrupted_boot(60, now=1001.0, boot_id="boot-2")
        assert rlg.is_restart_loop_tripped(3, 60, now=1002.0) is False
        rlg.record_restart_interrupted_boot(60, now=1002.0, boot_id="boot-3")
        assert rlg.is_restart_loop_tripped(3, 60, now=1003.0) is True

    def test_clear_resets(self):
        import gateway.restart_loop_guard as rlg
        rlg.check_and_record(3, 60, now=1000.0, boot_id="boot-1")
        rlg.check_and_record(3, 60, now=1001.0, boot_id="boot-2")
        rlg.clear()
        assert rlg.check_and_record(3, 60, now=1002.0, boot_id="boot-3") is False
    ...
    def test_trips_on_slow_crash_cycle_wider_than_window(self):
        ...
        import gateway.restart_loop_guard as rlg
        assert rlg.check_and_record(3, 60, now=1000.0, boot_id="boot-1") is False
        assert rlg.check_and_record(3, 60, now=1150.0, boot_id="boot-2") is False
        assert rlg.check_and_record(3, 60, now=1300.0, boot_id="boot-3") is True
    ...
    def test_slow_cycle_chain_is_persisted_not_truncated(self):
        ...
        import gateway.restart_loop_guard as rlg
        rlg.record_restart_interrupted_boot(60, now=1000.0, boot_id="boot-1")
        rlg.record_restart_interrupted_boot(60, now=1150.0, boot_id="boot-2")
        boots = rlg.record_restart_interrupted_boot(60, now=1300.0, boot_id="boot-3")
    ...
    def test_quiet_period_breaks_the_chain(self):
        ...
        import gateway.restart_loop_guard as rlg
        rlg.check_and_record(3, 60, now=1000.0, boot_id="boot-1")
        rlg.check_and_record(3, 60, now=1150.0, boot_id="boot-2")
        # 1h later: unrelated restart, chain reset to a single boot.
        assert rlg.check_and_record(3, 60, now=4800.0, boot_id="boot-3") is False
    ...
    def test_fast_respawn_loop_still_trips(self):
        ...
        import gateway.restart_loop_guard as rlg
        assert rlg.check_and_record(3, 60, now=1000.0, boot_id="boot-1") is False
        assert rlg.check_and_record(3, 60, now=1010.0, boot_id="boot-2") is False
        assert rlg.check_and_record(3, 60, now=1020.0, boot_id="boot-3") is True
    ...
    def test_max_gap_seconds_is_configurable(self):
        ...
        import gateway.restart_loop_guard as rlg
        assert rlg.check_and_record(3, 60, now=1000.0, max_gap_seconds=100, boot_id="boot-1") is False
        assert rlg.check_and_record(3, 60, now=1150.0, max_gap_seconds=100, boot_id="boot-2") is False
        assert rlg.check_and_record(3, 60, now=1300.0, max_gap_seconds=100, boot_id="boot-3") is False
    ...
    def test_window_seconds_floors_the_gap(self):
        ...
        import gateway.restart_loop_guard as rlg
        assert rlg.check_and_record(3, 900, now=1000.0, max_gap_seconds=100, boot_id="boot-1") is False
        assert rlg.check_and_record(3, 900, now=1400.0, max_gap_seconds=100, boot_id="boot-2") is False
        assert rlg.check_and_record(3, 900, now=1800.0, max_gap_seconds=100, boot_id="boot-3") is True

    def test_disabled_breaker_never_trips(self):
        import gateway.restart_loop_guard as rlg
        for index, ts in enumerate((1000.0, 1150.0, 1300.0, 1450.0)):
            assert rlg.check_and_record(0, 60, now=ts, boot_id=f"boot-{index}") is False
