...
Symptom (2026-09-24): Discord's native /model shows its option as
``name:claude-bpx-5/claude-fable-5-1``. Pasted into Telegram, the whole string
became the model id under the CURRENT provider
(``claude-apr/name:claude-bpx-5/claude-fable-5-1``) and broke the session.
