"""One ACTIVE result row per (session_id, tool_call_id) across archive_and_compact (t_aace5343).
...
def test_carried_tail_keeps_one_active_result_per_tool_call(db):
    """The 2026-09-24 shape: the carried tail re-inserts the exchange; the old copy is archived."""
