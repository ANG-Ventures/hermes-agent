...
def test_history_to_messages_preserves_tool_calls_for_resume_display():
    ...
    assert server._history_to_messages(history) == [
        ...
        # `context` is upstream's ARG-PREVIEW form: _tool_ctx was changed to
        # return the bare argument instead of a phrased label, which the
        # sibling test test_tool_ctx_sends_an_arg_preview_not_a_phrased_label
        # asserts directly. Union of both sides' intents.
        {
            "context": "resume",
            "name": "search_files",
            "role": "tool",
