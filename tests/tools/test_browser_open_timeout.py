...
class TestCommandTimeoutRecovery:
    ...
    def test_timeout_replaces_only_stuck_client(self, monkeypatch, tmp_path, cloud):
        ...
        # Hermetic: without this, hosts lacking a Chromium install trip the
        # missing-browser fast-fail and never reach the timeout-recovery path.
        monkeypatch.setattr(bt, "_chromium_installed", lambda: True, raising=False)
