...
def test_justified_route_reaches_child_credential_config_and_audit_log():
    ...
    audit_payload = str(audit_log.call_args)
    assert "gpt-6-astra-900k" in audit_payload
    assert "cross-module concurrency diagnosis" in audit_payload
