...
class CheckpointManager:
    ...
    def ensure_checkpoint(self, working_dir: str, reason: str = "auto") -> bool:
        ...
        # Skip root, home, and other overly broad directories. Resolve home
        # the same way abs_dir was resolved — on macOS $TMPDIR-style homes
        # live behind the /var -> /private/var symlink, and an unresolved
        # Path.home() string would never match the resolved abs_dir.
