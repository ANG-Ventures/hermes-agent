...
# (The fork's user-turn-boundary expiration — native image parts expiring to
# their text summaries, see agent/turn_context.py — still applies on top of
# this cap; it limits how LONG an embed rides, this limits how BIG it is.)
