...
def _(rid, params: dict) -> dict:
    try:
        ...
        payload = build_model_options_payload(
            ...
            # fork parity: the desktop/TUI picker honours the user's
            # model.picker hide/order config (and hides the internal Claude
            # failover lanes). Upstream's extracted wrapper defaults it off.
