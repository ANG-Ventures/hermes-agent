    ...
    def run_conversation(
        ...
        **_kwargs: Any,
        ...
        while True:
            ...
            if sleep_s:
                time.sleep(sleep_s)
            # Re-sample the clock AFTER the burn/sleep: the streamed-delta
            # cadence must reflect true elapsed wall-time (including the
            # slow-consumer stall), not the timestamp taken before the chunk.
            tick = time.monotonic()
